function cifar10_starter()
    ...
    net.layers{end+1} = struct('type', 'convolution',...
        'params', struct('weights', 0.1*randn(5,5,32,64)/sqrt(5*5*64/2), 'biases', zeros(64,1)),...
        'padding', [2 2]);
    ...
    % see the layer sizes
    [a, b] = evaluate(net, x_train(:,:,:,1:10), y_train(1:10), true);
    
    training_opts = struct('learning_rate', 5e-4,...
        'iterations', 5000,...
        'batch_size', 16,...
        'momentum', 0.95,...
        'weight_decay', 0.001);
    ...
    save('models/cifar10_Version3-2.mat', 'net');
